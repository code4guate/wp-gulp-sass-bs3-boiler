...
{
    wp_register_style('html5blank', get_template_directory_uri() . '/css/theme-styles.css', array(), '1.0', 'all');
...
add_action('wp_enqueue_scripts', 'htmlblank_scripts'); // Add Theme Scripts to Footer
